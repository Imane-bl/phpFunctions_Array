...
print_r(array_slice($chars_with_numeric_keys, 0, 2, True));//enregestrate my cases true 
  //[10] => 1
  //[20] => 2
  echo '</pre>';

  echo '<pre>';
  print_r($chars);//preserve array normale like first one 
  echo '</pre>';

  $nums = [10, 20, 30, 40, 50, 60, 70];
//here the array has an impact   splice ->delete 
  echo '<pre>';
